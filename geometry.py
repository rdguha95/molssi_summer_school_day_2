...
def build_bond_list(coordinates, max_bond=2.93, min_bond=0):
    ...
    coordinates : np.array
        An array of atomic coordinates. Size should be (n,3) ehere n is the number of particles
    ...
    -------
    bonds : dict
        A dictionary of bonds with atom pair tuples as keys, and calculate bond length as value
    """
